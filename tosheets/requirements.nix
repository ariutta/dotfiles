...
let
  ...
  generated = self: {
    ...
    "tosheets" = python.mkDerivation {
      name = "tosheets-0.2.0";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/cd/2a/f85f3b7128bd2a690985765330685efd2bc513d37f62f4dd8c4147ee34a3/tosheets-0.2.0.tar.gz"; sha256 = "dc7f151c118fecf6f20729f099abb25dc871018ed825f98edcf6426dc161ab05"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."docopt"
